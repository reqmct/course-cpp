...
TEST(OrderExecutionTest, decode_binary)
{
...
TEST(OrderRestatementTest, decode_binary)
{
    const std::vector<unsigned char> message = {
        0xBA, 0xBA,
        0x41, 0x00,
        ...
        0x41, 0x42, 0x43, 0x31, 0x32, 0x33, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x05, 0x10, 0x1E, 0xB7, 0x5E, 0x39, 0x2F, 0x02,
        0x4C,
        0x00,
        0x06,
        0x00,
    ...
    RestatementDetails decodedData = decode_order_restatement(message);
    EXPECT_EQ(decodedData.cl_ord_id, "ABC123");
    EXPECT_EQ(decodedData.reason, RestatementReason::Reload);
    EXPECT_NEAR(decodedData.active_volume, 100.0, eps);
    EXPECT_EQ(decodedData.secondary_order_id, "171WC100000A");
}

TEST(OrderRestatementTest, bitfields)
{
    auto availableBitfields = request_optional_fields_for_message(ResponseType::OrderRestatement);
    ASSERT_EQ(6, availableBitfields.size());
    bool referenceBitfields[15][8] = {
        { false, false, false, false, false, false, false, false },
        { false, false, false, false, false, false, false, false },
        { false, false, false, false, false, false, false, false },
